...
class AudioAEV25(pl.LightningModule):
    def __init__(self, learning_rate, run_name):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=64, kernel_size=(5,3), stride=(2,1)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=64, kernel_size=(5,3), stride=(2,1)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
            ...
            nn.ReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=32, kernel_size=(5,2)
            ),
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=16, kernel_size=(4,2)
            ),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(
