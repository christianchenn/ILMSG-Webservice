...
class AudioAEV32(pl.LightningModule):
    def __init__(self, learning_rate, run_name):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=32, kernel_size=(25,2)
            ),
            nn.BatchNorm2d(32),
            nn.LeakyReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=64, kernel_size=(25,1)
            ),
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=64, kernel_size=(25,1)
            ),
            nn.BatchNorm2d(64),
            nn.LeakyReLU(),
            nn.Conv2d(
            ...
            nn.LeakyReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=128, kernel_size=(20,1)
            ),
            nn.BatchNorm2d(128),
            nn.LeakyReLU(),
            nn.Conv2d(
                in_channels=128, out_channels=128, kernel_size=(13,1)
            ),
            nn.BatchNorm2d(128),
        )
