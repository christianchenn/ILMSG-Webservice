...
class AudioAEV44(pl.LightningModule):
    def __init__(self, learning_rate, run_name, yaml_file):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=128, kernel_size=(5,5)
            ),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=128, out_channels=64, kernel_size=(4,4)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
