...
# Menggunakan Pretrained Efficient Net
class Vid2SpeechV10(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        self.future_len = 26
        # python summary.py -m efficentnetv2s --start 0 --end 6 --freeze 9.0.block.0.0.weight --type 2d --out_channels 3
        pretrained_model = extract_layers(efficientnet_v2_s(weights=EfficientNet_V2_S_Weights.IMAGENET1K_V1).features, 0, 6)
        self.pretrained_model = freeze_layers(pretrained_model, "5.7.block.0.0.weight")
