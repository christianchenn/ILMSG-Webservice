...
class Vid2SpeechV29(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        pretrained_model = extract_layers(vgg16(weights=VGG16_Weights.IMAGENET1K_V1).features, 0, 31)
        self.pretrained_model = freeze_layers(pretrained_model, None)
