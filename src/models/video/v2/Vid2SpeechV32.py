...
# Target Audio (,2048)
class Vid2SpeechV32(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        self.future_len = 20 
        pretrained_model = extract_layers(vgg16(weights=VGG16_Weights.IMAGENET1K_V1).features, 0, 23)
        self.pretrained_model = freeze_layers(pretrained_model, "21.weight")
        ...
        self.attention = MultiheadAttention2D(in_channels=64, embed_dim=256, num_heads=4)
        # Encoders
