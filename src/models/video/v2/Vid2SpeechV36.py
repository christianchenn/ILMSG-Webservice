...
# Target Audio (,2048)
class Vid2SpeechV36(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        self.future_len = 20 
        pretrained_model = extract_layers(efficientnet_v2_m(weights=EfficientNet_V2_M_Weights.IMAGENET1K_V1).features, 0, 7)
        ...
        #     nn.ReLU(),
        # )
        self.attention = MultiheadAttention2D(in_channels=304, embed_dim=256, num_heads=4)
        # Encoders
