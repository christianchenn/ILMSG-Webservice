...
class AudioAEV23(pl.LightningModule):
    def __init__(self, learning_rate, run_name):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=8, kernel_size=5, stride=(2,1)
            ),
            nn.BatchNorm2d(8),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=8, out_channels=16, kernel_size=5, stride=(2,1)
            ),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(
            ...
            nn.ReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=64, kernel_size=(6,4)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=128, kernel_size=(6,3)
            ),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=128, out_channels=256, kernel_size=(6,3)
            ),
            nn.BatchNorm2d(256),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=256, out_channels=512, kernel_size=(6,3)
            ),
            nn.BatchNorm2d(512),
            nn.ReLU(),
        )
