...
# 8, 118, 16
class AudioAEV29(pl.LightningModule):
    def __init__(self, learning_rate, run_name):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=64, kernel_size=(15,2)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=64, kernel_size=(15,1)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=32, kernel_size=(15,1)
            ),
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=16, kernel_size=(15,1)
            ),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=16, out_channels=8, kernel_size=(15,1)
            ),
            nn.BatchNorm2d(8),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=8, out_channels=4, kernel_size=(10,1)
            ),
            nn.BatchNorm2d(4),
            nn.ReLU(),
        )
