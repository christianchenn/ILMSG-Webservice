...
# 8, 118, 16
class AudioAEV30(pl.LightningModule):
    def __init__(self, learning_rate, run_name):
        ...
        self.encoder = nn.Sequential(
            nn.Conv2d(
                in_channels=1, out_channels=128, kernel_size=(25,2)
            ),
            nn.BatchNorm2d(128),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=128, out_channels=64, kernel_size=(25,1)
            ),
            nn.BatchNorm2d(64),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=64, out_channels=32, kernel_size=(23,1)
            ),
            nn.BatchNorm2d(32),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=32, out_channels=16, kernel_size=(20,1)
            ),
            nn.BatchNorm2d(16),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=16, out_channels=8, kernel_size=(20,1)
            ),
            nn.BatchNorm2d(8),
            nn.ReLU(),
            nn.Conv2d(
                in_channels=8, out_channels=8, kernel_size=(20,1)
            ),
            nn.BatchNorm2d(8),
            nn.ReLU(),
        )
