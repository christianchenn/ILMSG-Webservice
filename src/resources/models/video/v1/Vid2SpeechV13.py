...
# Input 192x192 Transform 2
# Untuk Target 8x118x16
# Menggunakan Efficientnet
# Tanpa menggunakan ConvLSM
# Mencoba menggunakan loss function yang baru
class Vid2SpeechV13(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        self.future_len = 8
        # python summary.py -m efficentnetv2s --start 0 --end 8 --freeze 9.0.block.0.0.weight --type 2d --out_channels 3
        pretrained_model = extract_layers(efficientnet_v2_s(weights=EfficientNet_V2_S_Weights.IMAGENET1K_V1).features, 0, 8)
        self.pretrained_model = freeze_layers(pretrained_model, "6.9.block.0.0.weight")
    ...
    def test_step(self, test_batch, batch_idx):
        ...
        # B, C, NF, HW -> B, NF, C, HW 
        y_hat = y_hat.permute(0, 2, 1, 3)
        test_loss = self.caluculate_loss(y_hat, y)
