...
from src.utils.model import extract_model
...
class Vid2SpeechV3(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        self.future_len = 8
        pretrained_model = extract_model(mc3_18(weights=MC3_18_Weights.DEFAULT), "layer1", "layer2", "layer2")
