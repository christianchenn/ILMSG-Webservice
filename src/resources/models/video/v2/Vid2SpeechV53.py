...
# Target Audio (,2048)
class Vid2SpeechV53(pl.LightningModule):
    def __init__(self, run_name, learning_rate=1e-4, yaml_file=None):
        ...
        pretrained_model = extract_layers(mc3_18(weights=MC3_18_Weights.DEFAULT), 0, 5)
        self.pretrained_model = freeze_layers(pretrained_model, "4.1.conv1.0.weight")
        ...
        self.attention_1 = MultiheadAttention2D(in_channels=512, embed_dim=256, num_heads=4, mask=None)  
